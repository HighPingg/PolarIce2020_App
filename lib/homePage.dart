              ...
              children: <Widget>[
                ...
                Center(
                  child: Text(
                    'WELCOME',
                    style:
                        TextStyle(fontSize: 50.0, fontFamily: 'ArchivoBlack'),
                  ),
                ),
                Center(
                  child: Text(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage('assets/images/ChristmasTree.jpg'),
                        fit: BoxFit.cover,
                ...
                selectionContainer(context, 'Bundles',
                    'assets/images/Sprinkles.jpg', Bundles.toList()),
                selectionContainer(context, 'Boxes',
                    'assets/images/iceCreamScoops.jpg', Boxes.toList()),
              ],
            ),
          ),
        ],
